...
void setup() {
  ...
  PImage friends = loadImage("donald-trump-grow-up.jpg");  // 2. Change this to match the name of your photo. 
  size(920,537);
  // 3. Set your friends as the background.
  background(friends);

  // 4. Find an image of a mustache, and drop it onto this sketch. 
  mustache = loadImage("error.jpg"); // 5. Change this to match your file name.
}
